...
<html>
							...
							<div class="col-md-12">
								<table class='table borderless'>
									<tr>
										...
										<td>
											<select id="filter-kurikulum" class='form-control'>
												...
												<option value="${kurikulum.idKurikulum}">${kurikulum.namaKurikulum}</option>
												</c:forEach>
											</select>
										</td>
									</tr>
									<tr>
										<td>Mahasiswa</td>
										<td>
											<input type='text' id='nmPd' class='form-control' />
	...
	<div id="modal-peserta-didik" class="modal fade">
		...
		<content tag="scripts">			
			...
			<script src="${pageContext.servletContext.contextPath}/resources/js/ekuivalensi/laporan.js" type="text/javascript" ></script>\

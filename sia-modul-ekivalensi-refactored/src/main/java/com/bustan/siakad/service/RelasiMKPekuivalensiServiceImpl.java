...
@Service
public class RelasiMKPekuivalensiServiceImpl implements RelasiMKPekuivalensiService{
	...
	@Autowired
	RelasiMKPekuivalensiRepository relasiMKPekuivalensiRepository;
	...
	@Override
	public List<RelasiMKPekuivalensi> get(String where, String order, int limit,
			int offset) {
		return relasiMKPekuivalensiRepository.get(where,order,limit,offset);
	}

	@Override
	public RelasiMKPekuivalensi getById(UUID idMKLuar) {
		return relasiMKPekuivalensiRepository.getById(idMKLuar);
	}

	@Override
	public String save(RelasiMKPekuivalensi relasiMKPekuivalensi) {
		if(relasiMKPekuivalensi.getIdRelasiMKPekuivalensi() != null)
		{
			//update
			relasiMKPekuivalensiRepository.update(relasiMKPekuivalensi);
			return relasiMKPekuivalensi.getIdRelasiMKPekuivalensi().toString();
		}
		else
		{
			//insert
			return relasiMKPekuivalensiRepository.insert(relasiMKPekuivalensi).toString();
		}
	}

	@Override
	public void delete(RelasiMKPekuivalensi relasiMKPekuivalensi) {
		relasiMKPekuivalensiRepository.delete(relasiMKPekuivalensi);
	}

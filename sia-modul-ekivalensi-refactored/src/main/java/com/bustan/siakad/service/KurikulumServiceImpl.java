...
import com.bustan.siakad.repository.KurikulumRepository;


@Service
public class KurikulumServiceImpl implements KurikulumService {

	private String[] column = {"kurikulum.idKurikulum","satMan.nmSatMan","kurikulum.namaKurikulum","kurikulum.thnMulai","kurikulum.thnAkhir","kurikulum.aStatusKuriukulum"};

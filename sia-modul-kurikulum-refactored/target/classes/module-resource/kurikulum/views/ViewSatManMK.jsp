			...
			<script>
				$(document).ready(function(){
						...
						$('#masterpage').masterPage(
						{
							...
							dataUrl: context_path+'modul/kurikulum/matakuliah/satuanmanajemen/json',
							detailUrl: context_path+'modul/kurikulum/matakuliah/satuanmanajemen/edit',
							addUrl: context_path+'modul/kurikulum/matakuliah/satuanmanajemen/simpan',
							editUrl: context_path+'modul/kurikulum/matakuliah/satuanmanajemen/simpan',
							deleteUrl: context_path+'modul/kurikulum/matakuliah/satuanmanajemen/deletemany',

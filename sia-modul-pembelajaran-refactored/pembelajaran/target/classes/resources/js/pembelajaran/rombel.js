...
$(document).ready(function(){
	$('#masterpage').masterPage(
	{
		...
		dataUrl: context_path+'modul/pembelajaran/rombel/json',
		detailUrl: context_path+'modul/pembelajaran/rombel/edit',
		addUrl: context_path+'modul/pembelajaran/rombel/simpan',
		editUrl: context_path+'modul/pembelajaran/rombel/simpan',
		deleteUrl: context_path+'modul/pembelajaran/rombel/deletemany',
		primaryKey: 'idRombel',
        order: [[2,"desc"]],
		editOnClick: false,
		editOnClickRow: true,
	...
	{
		detailFocusId: '#idPd',
		dataUrl: context_path+'modul/pembelajaran/rombel/jsonpesertadidik',
		primaryKey: 'idPd',
        order: [[1,"asc"]],
		editOnClick: false,
		...
		filters:[{id:'#pesertadidik-filter',name:'angkatan_pd'},{id:'#satman-filter',name:'idSatMan'}]
	});
	
	$('#anggota-rombel').masterPage(
	{
		detailFocusId: '#idAnggotaRombel',
		dataUrl: context_path+'modul/pembelajaran/rombel/jsonanggotarombel',
		deleteUrl: context_path+'modul/pembelajaran/rombel/deleteanggotarombel',
	...
	tambahkan = function(id){
		...
		$.ajax({
			url: context_path+"modul/pembelajaran/rombel/tambahkan",
			data : tempData,
			type : 'post',
	...
	$('.tambahkan-all').click(function(){
		...
		$.ajax({
			url: context_path+"modul/pembelajaran/rombel/tambahkanmany",
			data : formdata,
			type : 'post',
			success: function(data)
			{

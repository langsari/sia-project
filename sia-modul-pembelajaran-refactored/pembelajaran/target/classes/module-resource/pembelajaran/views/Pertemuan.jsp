	...
	<div class="row" id="masterpage">
		...
		$(document).ready(function(){
			$('#masterpage').masterPage(
			{
				...
				dataUrl: context_path+'modul/pembelajaran/beritaacara/json',
				primaryKey: 'idPemb',
		        order: [[1,"asc"]],
				editOnClick: false,
				...
				cols: [
					...
					{ 
						...
						bSearchable: false,
						mRender: function(data,type,full){
							var action =' <a target="_blank" href="'+context_path+'modul/pembelajaran/beritaacara/'+full[0]+'" class="btn btn-primary">Lihat Berita Acara</a>';
							return action;
						}
					}
				],

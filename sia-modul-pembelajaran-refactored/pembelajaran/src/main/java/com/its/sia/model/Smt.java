...
public class Smt {
    ...
    @NotNull(message="Jumlah Pertemuan tidak boleh kosong")
	@Column(name="jml_pertemuan")
	private Integer jmlPertemuan;
    
    @NotNull(message="Semester Terhitung tidak boleh kosong")
	@Column(name="smt_terhitung")
	private Boolean smtTerhitung;
	...
	public Boolean getSmtTerhitung() {
		return smtTerhitung;
	}

	public void setSmtTerhitung(Boolean smtTerhitung) {
		this.smtTerhitung = smtTerhitung;
	}

...
$(document).ready(function(){
	...
	{
		detailFocusId: '#idPtk',
		dataUrl: context_path+'modul/pembelajaran/perwalian/jsonperwalian',
		primaryKey: 'idPtk',
        order: [[0,"asc"]],
		editOnClick: false,
	...
	{
		detailFocusId: '#idPd',
		dataUrl: context_path+'modul/pembelajaran/perwalian/jsonanakwali',
		primaryKey: 'idPd',
        order: [[1,"asc"]],
		editOnClick: false,
		editOnClickRow: false,
	...
	{
		detailFocusId: '#idPd',
		dataUrl: context_path+'modul/pembelajaran/perwalian/jsonnonwali',
		primaryKey: 'idPd',
        order: [[1,"asc"]],
		editOnClick: false,
		editOnClickRow: false,
	...
	lepaskan = function(id)
	{
		...
		$.ajax({
			url: context_path+"modul/pembelajaran/perwalian/lepaskan",
			data : tempData,
			type : 'post',
	...
	tambahkan = function(id){
		...
		eval("var tempData = {'idPd[]' : '"+id+"','idPtk' : '"+$("#idPtk").val()+"'};");
		$.ajax({
			url: context_path+"modul/pembelajaran/perwalian/tambahkan",
			data : tempData,
			type : 'post',
			success: function(data)
			{
